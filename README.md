...
- JDK 25 +（YachiyoService）
- Python 3.13（YachiyoAI）
...
1. **克隆仓库**
   - Service 
      ```bash
         https://github.com/Tsukimi-Yachiyo/YachiyoService.git
         cd YachiyoService
      ```
   - Web 
      ```bash
         https://github.com/Tsukimi-Yachiyo/YachiyoWeb.git
         cd YachiyoWeb
      ```
   -  AI
      ```bash
         https://github.com/Tsukimi-Yachiyo/YachiyoAI.git
         cd YachiyoAI
      ```
...
| AI Agent, QQ Robot | 凉, 酒精 | AI 功能和机器人开发 |
...
- QQ 群：1094218305
- bilibili [视频](https://www.bilibili.com/video/BV1zjApzDE8Q/?spm_id_from=333.1387.homepage.video_card.click&vd_source=8bcc7903a045b58528d1355ddb11a34e)

- 个人联系方式
- - Drayee [github](https://github.com/Drayee)
